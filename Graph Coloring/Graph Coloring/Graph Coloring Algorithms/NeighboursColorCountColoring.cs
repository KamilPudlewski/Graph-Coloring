...
{
    public class NeighboursColorCountColoring
    {
        ...
        public NeighboursColorCountColoring(Graph graph)
        {
            this.graph = graph;
        }

        public NeighboursColorCountColoring(Graph graph, bool saveHistory)
        {
            this.graph = graph;
